...
import com.jeil.emarket.adapters.chart.ChartCustomerAdapter;
...
/* renamed from: b.f.a.g.d.a.s0.d */

public class FragmentAnayCustomer extends FragmentChart implements BaseInterface, InterfaceVoid {

    /* renamed from: M0 */
    public ChartCustomerAdapter f9736M0;

    /* renamed from: b.f.a.g.d.a.s0.d$a */
    public class a extends TypeToken<List<ChartCustomer>> {
        public a(FragmentAnayCustomer fragmentAnayCustomer) {
        }
    }

    /* renamed from: b.f.a.g.d.a.s0.d$b */
    public class b extends TypeToken<AnalyticsStats> {
        public b(FragmentAnayCustomer fragmentAnayCustomer) {
        }
    }

    public FragmentAnayCustomer(View view, AnalyticsProvider analyticsProvider, BaseActivity activityC1391g1) {
        this.f9694r0 = view;
    ...
    public void showBootomMenu() {
        ...
        if (this.xRecyclerView != null) {
            this.f9736M0 = new ChartCustomerAdapter(this.baseActivity);
            this.xRecyclerView.setAdapter(this.f9736M0);
            m5172c(this.xRecyclerView.arrayList.get(0), this.baseActivity.getResources().getString(R.string.input_customer_related));
        }
    }
    ...
    public void mo4890V0() {
        ...
        new API_PROVIDER(getContext(), "get_chart_customers", this).get("e7/stats/customers", this.jsonObject);
    }
    ...
    public void mo4891W0() {
        ...
        if (this.f9689K0) {
            ...
            ChartCustomer chartCustomer = new ChartCustomer();
            chartCustomer.type = "shimmer";
            for (int i = 0; i < 6; i++) {
                arrayList.add(chartCustomer);
            }
            ChartCustomerAdapter c1785d = this.f9736M0;
            c1785d.arrayList = arrayList;
            c1785d.notifyDataSetChanged();
        } else {
            ChartCustomerAdapter c1785d2 = this.f9736M0;
            c1785d2.arrayList = new ArrayList();
            c1785d2.notifyDataSetChanged();
    ...
    public void mo4478a(java.lang.String str, java.lang.String str2, int i, Context context) {
        if (str == null || str.length() <= 0 || !str2.equals("get_chart_customers")) {
            return;
        }
        m4889U0();
        try {
            ...
            if (SimpleVM.f8836d) {
                m4892X0();
                this.f9736M0.addAll(list);
            } else {
                if (this.f9137a0 == 0) {
                    this.f9736M0.addAll(list);
                } else {
                    this.f9736M0.addModList(list, this.xRecyclerView.arrayList.size() + 1, false);
                }
                if (list.size() == 0) {
