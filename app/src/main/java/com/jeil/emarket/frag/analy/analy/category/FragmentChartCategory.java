package com.jeil.emarket.frag.analy.analy.category;
...
import com.jeil.emarket.adapters.chart.ChartCategoryAdapter;
...
/* renamed from: b.f.a.g.d.a.r0.d */

public class FragmentChartCategory extends FragmentChart implements BaseInterface, InterfaceVoid {

    /* renamed from: M0 */
    public ChartCategoryAdapter f9732M0;

    /* renamed from: b.f.a.g.d.a.r0.d$a */
    public class a extends TypeToken<List<ChartCategory>> {
        public a(FragmentChartCategory fragmentChartCategory) {
        }
    }

    /* renamed from: b.f.a.g.d.a.r0.d$b */
    public class b extends TypeToken<AnalyticsStats> {
        public b(FragmentChartCategory fragmentChartCategory) {
        }
    }

    public FragmentChartCategory(View view, AnalyticsProvider analyticsProvider, BaseActivity activityC1391g1) {
        this.f9694r0 = view;
    ...
    public void showBootomMenu() {
        ...
        if (this.xRecyclerView != null) {
            this.f9732M0 = new ChartCategoryAdapter(this.baseActivity);
            this.xRecyclerView.setAdapter(this.f9732M0);
            m5172c(this.xRecyclerView.arrayList.get(0), this.baseActivity.getResources().getString(R.string.input_category_name));
        }
    }
    ...
    public void mo4890V0() {
        ...
        new API_PROVIDER(getContext(), "get_chart_categories", this).get("e7/stats/category", this.jsonObject);
    }
    ...
    public void mo4891W0() {
        ...
        if (this.f9689K0) {
            ...
            chartCategory.type = "shimmer";
            for (int i = 0; i < 6; i++) {
                arrayList.add(chartCategory);
            }
            ChartCategoryAdapter c1784c = this.f9732M0;
            c1784c.arrayList = arrayList;
            c1784c.notifyDataSetChanged();
        } else {
            ChartCategoryAdapter c1784c2 = this.f9732M0;
            c1784c2.arrayList = new ArrayList();
            c1784c2.notifyDataSetChanged();
    ...
    public void mo4478a(java.lang.String str, java.lang.String str2, int i, Context context) {
        if (str == null || str.length() <= 0 || !str2.equals("get_chart_categories")) {
            return;
        }
        m4889U0();
        try {
            ...
            if (SimpleVM.f8836d) {
                m4892X0();
                this.f9732M0.addAll(list);
            } else {
                if (this.f9137a0 == 0) {
                    this.f9732M0.addAll(list);
                } else {
                    this.f9732M0.addModList(list, this.xRecyclerView.arrayList.size() + 1, false);
                }
                if (list.size() == 0) {
