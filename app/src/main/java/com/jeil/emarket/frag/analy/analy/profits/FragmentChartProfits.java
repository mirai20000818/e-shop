...
import com.jeil.emarket.adapters.chart.ChartProfitAdapter;
...
/* renamed from: b.f.a.g.d.a.v0.d */

public class FragmentChartProfits extends FragmentChart implements BaseInterface, InterfaceVoid {

    /* renamed from: M0 */
    public ChartProfitAdapter f9749M0;

    /* renamed from: b.f.a.g.d.a.v0.d$a */
    public class a extends TypeToken<List<ChartProfit>> {
        public a(FragmentChartProfits fragmentChartProfits) {
        }
    }

    /* renamed from: b.f.a.g.d.a.v0.d$b */
    public class b extends TypeToken<AnalyticsStats> {
        public b(FragmentChartProfits fragmentChartProfits) {
        }
    }

    public FragmentChartProfits(View view, AnalyticsProvider analyticsProvider, BaseActivity activityC1391g1) {
        this.f9694r0 = view;
    ...
    public void showBootomMenu() {
        ...
        if (this.xRecyclerView != null) {
            this.f9749M0 = new ChartProfitAdapter(this.baseActivity);
            this.xRecyclerView.setAdapter(this.f9749M0);
        }
    }
    ...
    public void mo4890V0() {
        ...
        new API_PROVIDER(getContext(), "get_chart_profits", this).get("e7/stats/profit", this.jsonObject);
    }
    ...
    public void mo4891W0() {
        ...
        if (this.f9689K0) {
            ...
            ChartProfit chartProfit = new ChartProfit();
            chartProfit.type = "shimmer";
            for (int i = 0; i < 6; i++) {
                arrayList.add(chartProfit);
            }
            ChartProfitAdapter c1788g = this.f9749M0;
            c1788g.arrayList = arrayList;
            c1788g.notifyDataSetChanged();
        } else {
            ChartProfitAdapter c1788g2 = this.f9749M0;
            c1788g2.arrayList = new ArrayList();
            c1788g2.notifyDataSetChanged();
    ...
    public void mo4478a(java.lang.String str, java.lang.String str2, int i, Context context) {
        if (str == null || str.length() <= 0 || !str2.equals("get_chart_profits")) {
            return;
        }
        m4889U0();
        try {
            ...
            if (SimpleVM.f8836d) {
                m4892X0();
                this.f9749M0.addAll(list);
            } else {
                if (this.f9137a0 == 0) {
                    this.f9749M0.addAll(list);
                } else {
                    this.f9749M0.addModList(list, this.xRecyclerView.arrayList.size() + 1, false);
                }
                if (list.size() == 0) {
