...
/* renamed from: b.f.a.g.d.a.u0.b */

public class FragmentAnalyProduct extends FragmentChart {
    public FragmentAnalyProduct(View view, AnalyticsProvider analyticsProvider, BaseActivity activityC1391g1) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        final View inflate = layoutInflater.inflate(R.layout.fragment_analytics_product, viewGroup, false);
        ...
        this.f9692p0.f10527i.observe(getViewLifecycleOwner(), new Observer() { // from class: b.f.a.g.d.a.u0.a
            @Override // p000a.p060o.InterfaceC0405p
            
            public final void onChanged(Object obj) {
                FragmentAnalyProduct.this.m5212a(inflate, (AnalyticsStats) obj);
            }
        });
        m5186s(inflate);
    ...
    public  void m5212a(View view, AnalyticsStats analyticsStats) {
    ...
    public void mo5167b(View view, String str) {
        super.mo5167b(view, "product");
    }

    @Override // p078b.p159f.p160a.p231g.p243d.p244a.C2519n0

    public void mo5177e(View view, String str) {
        super.mo5177e(view, "product");
    }
}
